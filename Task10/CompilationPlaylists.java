...
public class CompilationPlaylists {
    ...
    public CompilationPlaylists(String userInput, Music[] sortedByGenres) {
        ...
        if (Objects.equals(userInput, "Move")) {
            ...
            playList = CreatePlayList(sortedByGenres, "Pop", "HipHop");

        }

        if(Objects.equals(userInput, "Slowdown")) {

            playList = CreatePlayList(sortedByGenres, "Classic", "Relax");

        }

        if (Objects.equals(userInput, "Training")) {

            playList = CreatePlayList(sortedByGenres , "Rock", "Rap");
